...
public class ThongTinMonFrag extends Fragment {
    ...
    private FoodRatingDetailsAdapter foodDetailsAdapter;
    private List<FoodRatingDetails> foodDetailsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        foodDetailsList.add(new FoodRatingDetails("anh_dai_dien", "Malenia", 4, "Đồ ăn rất ngon."));
        foodDetailsList.add(new FoodRatingDetails("my_avatar", "Elysia", 5, "Gà rán gọi ra vẫn còn nóng, mềm mọng nước, bột gà giòn tan. Khoai tây chiên giòn ăn đã cái miệng."));
        foodDetailsList.add(new FoodRatingDetails("anh_dai_dien", "Fire Keeper", 3, "Khoai tây hơi mềm."));

        // Tạo Adapter và liên kết với RecyclerView
        foodDetailsAdapter = new FoodRatingDetailsAdapter(getContext(), foodDetailsList);
